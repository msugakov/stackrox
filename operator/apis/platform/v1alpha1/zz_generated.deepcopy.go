...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CentralDBComponentSpec) DeepCopyInto(out *CentralDBComponentSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CentralDBComponentSpec.
func (in *CentralDBComponentSpec) DeepCopy() *CentralDBComponentSpec {
	if in == nil {
		return nil
	}
	out := new(CentralDBComponentSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CentralSpec) DeepCopyInto(out *CentralSpec) {
	*out = *in
	...
	if in.CentralDB != nil {
		in, out := &in.CentralDB, &out.CentralDB
		*out = new(CentralDBComponentSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.Scanner != nil {
