...
type NetworkEndpoint struct {
	...
	Originator           *ProcessIndicatorUniqueKey `protobuf:"bytes,3,opt,name=originator,proto3" json:"originator,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                   `json:"-"`
	XXX_unrecognized     []byte                     `json:"-"`
	XXX_sizecache        int32                      `json:"-"`
}
...
func (m *NetworkEndpoint) GetOriginator() *ProcessIndicatorUniqueKey {
	if m != nil {
		return m.Originator
	}
	return nil
...
func (*NetworkEntityInfo_Deployment_ListenPort) Descriptor() ([]byte, []int) {
	return fileDescriptor_a6317ef286eb605d, []int{6, 0, 0}
}
...
func (*NetworkEntityInfo_ExternalSource) Descriptor() ([]byte, []int) {
	return fileDescriptor_a6317ef286eb605d, []int{6, 1}
}
...
var fileDescriptor_a6317ef286eb605d = []byte{
	...
	,
}
...
func (m *NetworkEndpoint) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.Originator == nil {
				m.Originator = &ProcessIndicatorUniqueKey{}
			}
