...
class ImageScanningTest extends BaseSpecification {
    ...
    def "Verify Image Registry+Scanner Integrations: #testName"() {
        ...
        assert cves.containsKey(integration)
        for (String cve : cves[integration]) {
        ...
        cves = [
                // quay scanner includes component name with vulns
                "quay": ["CVE-2016-2781 coreutils", "CVE-2014-6271 bash"],
                "gcr": ["CVE-2016-2781", "CVE-2017-9614"],
        ]
    }
